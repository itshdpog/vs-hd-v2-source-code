...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Merrimation',			'bigdick',		'Art and Animation',					'https://www.youtube.com/channel/UC-wWl6ba3Wn5XqzX5bMcYWQ',		'8b33ff'],
			['Novikond',			'novi',		'Lua Coding',					'https://www.youtube.com/channel/UCzhb0v_ECdeRm0u-h6s-TlA',		'5f4b80'],
