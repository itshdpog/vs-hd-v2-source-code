...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('freakyHD'));
			// FlxG.sound.list.add(music);
			// music.play();

			if(FlxG.sound.music == null) {
				FlxG.sound.playMusic(Paths.music('freakyHD'), 0);
...
//		credGroup.add(blackScreen);
		var blackScreen:FlxSprite = new FlxSprite().loadGraphic(Paths.image('BG', 'shared'));
//		blackScreen.color = 0xFFea71fd;
//		blackScreen.setGraphicSize(Std.int(blackScreen.width * 1.0));
		...
		if (FlxG.random.bool(5))
			{
				...
				{
					case 1:
						createCoolText(['Basic White Bitch', 'SmashAbug', 'Good Composer', 'NO BITCH MAN']);
					// credTextShit.visible = true;
					case 2:
						addMoreText('aka the worst modders ever');
					// credTextShit.text += '\npresent...';
					...
					// credTextShit.visible = false;
					case 9:
						addMoreText('Masked Showdown');
					case 10:
						addMoreText('By');
					case 11:
						addMoreText('some idiots');
					case 12:
						addMoreText('THIS TOOK TOO LONG');
					case 13:
