...
class FreeplayCategory2State extends MusicBeatState{
	...
	{
		addSong('Caves', 1, 'hd', FlxColor.GRAY);
		addSong('Disc', 2, 'hd', FlxColor.GRAY);
        addSong('Carrot', 3, 'hd', FlxColor.GRAY);
        addSong('Goofy', 4, '144p', FlxColor.GRAY);
        addSong('Fun', 5, '144p', FlxColor.GRAY);
        addSong('Whar', 6, '144p', FlxColor.GRAY);
